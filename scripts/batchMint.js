...
async function main() {
  ...
  const contractAddress = "0x724db22da1c086822Bf44381a59316D4780db136";

  // Get the contract factory and attach it to the signer
  const IndianNFT = await ethers.getContractFactory("Poly1", signer);
  ...
  console.log("5 tokens are Minted");
}
