...
const ABI = require("../artifacts/contracts/Poly1.sol/Poly1.json");
...
async function main() {
  ...
  const NFT = await ethers.getContractFactory("Poly1");
  const nft = await NFT.attach("0x724db22da1c086822Bf44381a59316D4780db136");
  ...
  console.log("The Approval is confirmed");
  ...
  console.log("It has been approved and deposited");
